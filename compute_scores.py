...
from models.estimators import SEvaluator, TEvaluator, DREvaluator, CausalForestEvaluator
...
def get_parser():
    ...
    # Estimation
    parser.add_argument('--em', dest='estimation_model', type=str, choices=['sl', 'tl', 'dr', 'two-head', 'cf'], default='sl')
