import os
import meta_comparers_iter as mci
...
for ds in datasets:
    ...
    mci.compare_metrics_all_val(all_cate_models, plugin_models, matching_ks, rscore_base_models, base_dir_val_ds, plugin_dir_ds, matching_dir_ds, rscore_dir_ds, all_metrics[ds]).to_csv(os.path.join(out_dir, f'{ds}_compare_metrics_val_iter.csv'), index=False)
