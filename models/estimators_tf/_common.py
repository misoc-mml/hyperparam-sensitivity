...
def get_params(name):
    if name == 'mlp':
        return {'n_layers': [1, 2], 'n_units': [4, 8, 16, 32, 64, 128], 'learning_rate': [1e-4, 1e-3], 'activation': ['relu'], 'dropout': [0.25], 'l2': [1e-3], 'batch_size': [32, 64, 128], 'epochs': [10000], 'epochs_are_steps': [True]}
    elif name == 'two-head':
        return {'n_layers': [1, 2], 'n_layers2': [0, 1, 2], 'n_units': [4, 8, 16, 32, 64, 128], 'learning_rate': [1e-4, 1e-3], 'activation': ['relu'], 'dropout': [0.0, 0.25], 'l2': [0.0, 1e-3], 'batch_size': [32, 64, 128, 256, -1], 'epochs': [10000], 'epochs_are_steps': [True]}
    else:
